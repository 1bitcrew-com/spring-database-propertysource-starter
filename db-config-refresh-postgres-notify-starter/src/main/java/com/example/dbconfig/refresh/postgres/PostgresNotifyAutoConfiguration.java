...
@ConditionalOnBean({ DataSource.class, DbConfigRefreshService.class })
...
public class PostgresNotifyAutoConfiguration {
    ...
    PostgresNotifyListener postgresNotifyListener(DataSource dataSource,
        ...
        return new PostgresNotifyListener(dataSource, refreshService, state, properties, payloadInterpreter, metrics);
    }
