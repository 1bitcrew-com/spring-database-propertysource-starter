...
import com.example.dbconfig.refresh.DbConfigRefreshService;
import com.example.dbconfig.refresh.DbConfigRefreshState;
import com.example.dbconfig.refresh.RefreshResult;
import com.example.dbconfig.refresh.RefreshTrigger;
...
public class PostgresNotifyListener implements SmartLifecycle {
    ...
    public PostgresNotifyListener(DataSource dataSource,
            DbConfigRefreshService refreshService,
        ...
        this(dataSource, refreshService, state, properties, payloadInterpreter, metrics, Clock.systemUTC());
    }
    ...
    private void onNotification(String payload) {
        ...
        RefreshResult result = refreshService.refreshNow(RefreshTrigger.EVENT);
